 ...
 * Filtering types
 */
export type FilterOperator = 'eq' | 'ne' | 'gt' | 'gte' | 'lt' | 'lte' | 'like' | 'ilike' | 'startsWith' | 'endsWith' | 'contains' | 'in' | 'notIn' | 'isNull' | 'isNotNull' | 'between';
...
export declare const createTraceId: (value: string) => TraceId;
