 ...
 */
export type ValidationRule<T = unknown> = (value: T, context?: ValidationContext) => ValidationIssue[];
/**
 ...
 */
export type BuiltInValidationRules = 'required' | 'minLength' | 'maxLength' | 'min' | 'max' | 'email' | 'url' | 'uuid' | 'date' | 'numeric' | 'alpha' | 'alphanumeric' | 'regex' | 'oneOf' | 'array' | 'object' | 'custom';
/**
