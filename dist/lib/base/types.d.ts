 ...
 */
export interface IRepository<TEntity extends BaseEntity, TCreateInput = Partial<TEntity>, TUpdateInput = Partial<TEntity>> {
 ...
 */
export interface IService<TEntity extends BaseEntity, TCreateInput = Partial<TEntity>, TUpdateInput = Partial<TEntity>> {
    create(data: TCreateInput, options?: CreateOptions): Promise<TEntity>;
    findById(id: EntityId, options?: FindOptions): Promise<TEntity | null>;
    update(id: EntityId, data: TUpdateInput, options?: UpdateOptions): Promise<TEntity>;
    delete(id: EntityId, options?: DeleteOptions): Promise<void>;
...
export interface IRepositoryFactory {
    create<TEntity extends BaseEntity>(entityType: string, config?: RepositoryConfig): IRepository<TEntity>;
}
/**
