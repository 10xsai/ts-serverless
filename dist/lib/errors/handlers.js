...
import { createValidationErrorResponse, createNotFoundResponse, createUnauthorizedResponse, createForbiddenResponse, createConflictResponse, createRateLimitResponse, createServerErrorResponse, toHttpResponse } from '../utils/response.js';
/**
 ...
 */
export const handleErrorAsHttpResponse = async (error, context) => {
 ...
 */
export const transformToBaseError = (error, context) => {
 ...
 */
export const shouldExposeMessage = (error) => {
 ...
 */
export const createErrorContext = (operation, entityType, traceId) => {
    return {
        operation,
        entityType,
