...
export class SchemaBuilder {
     ...
     */
    public addTable(definition: TableDefinition): this {
     ...
     * @returns Schema builder instance
     */
    public addIndex(definition: IndexDefinition): this {
     ...
     * @returns Schema builder instance
     */
    public addConstraint(definition: ConstraintDefinition): this {
...
export class TableBuilder {
     ...
     * @returns Table builder instance
     */
    public setPrimaryKey(columns: string[]): this {
...
export class ColumnBuilder {
     ...
     * @returns Column builder instance
     */
    public setDefault(value: unknown): this {
...
export class SchemaValidator {
     ...
     */
    public static validate(schema: SchemaDefinition): {
        valid: boolean;
        errors: string[];
    } {
        const errors: string[] = [];
     ...
     */
    private static validateTable(table: TableDefinition): string[] {
        const errors: string[] = [];
     ...
     * @returns Validation errors
     */
    private static validateColumn(column: ColumnDefinition): string[] {
        const errors: string[] = [];
 ...
 * @returns Schema builder instance
 */
export function createSchema(name: string, version?: string): SchemaBuilder {
 ...
 * @returns Column builder instance
 */
export function createColumn(name: string, type: string): ColumnBuilder {
